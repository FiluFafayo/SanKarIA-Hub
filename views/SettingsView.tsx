            ...
            <nav className="flex flex-row md:flex-col gap-2">
             ...
             {userEmail && (
                <div className="pt-4 mt-4 border-t border-amber-800/30">
                    <p className="text-sm">Anda masuk sebagai: <strong className="text-amber-300">{userEmail}</strong></p>
                    <button onClick={onSignOut} className="mt-2 text-sm font-cinzel bg-red-800 hover:bg-red-700 text-white px-4 py-1 rounded transition-colors">
                        Keluar
                    </button>
                </div>
            )}
