...
export const ViewWrapper: React.FC<ViewWrapperProps> = ({ children, onClose, title }) => {
  return (
    <div className="w-screen h-screen bg-bg-primary text-text-primary flex flex-col animate-fade-in">
      ...
      {/* FASE 0: Rombak layout modal menjadi fullscreen scrollable (hapus max-w-7xl, mx-auto) */}
